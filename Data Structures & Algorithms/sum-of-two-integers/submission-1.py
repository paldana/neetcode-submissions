class Solution:
    def getSum(self, a: int, b: int) -> int:
        ...
        while b != 0:               # "b will be used for carries"
            tmp = (a & b) << 1      # if we have a potential carry value, shift it to the left by 1 and store in a temp variable
            a = (a ^ b) & mask      # 
            b = tmp & mask
...
""" 
SOLUTION FROM A COMMENT IN NEETCODE'S JAVA SOLUTION VIDEO ON YOUTUBE - https://www.youtube.com/watch?v=gVUrDV4tZfY&t=691s
